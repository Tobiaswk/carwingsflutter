              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text('Consumption'),
                      Text(kWhUsed, style: TextStyle(fontSize: 25.0)),
                    ],
                  ),
                ],
              ),
              Row(
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text('Trips done'),
                      Text(tripsNumber, style: TextStyle(fontSize: 25.0)),
                    ],
                  ),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text('Travel time'),
                      Text(
                        '${travelTime.inHours == 0
                            ? travelTime.inMinutes == 0
                                  ? '-'
                                  : '${travelTime.inMinutes} mins'
                            : '${travelTime.inHours} hrs'}',
                        style: TextStyle(fontSize: 25.0),
                      ),
                    ],
                  ),
