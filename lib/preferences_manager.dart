...
class PreferencesManager {
  ...
  Future<Null> setLogin(String username, String password) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    preferences.setString(PREF_LOGIN, json.encode(new Login(username: username, password: password).toJson()));
  }
